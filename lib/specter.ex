defmodule Specter do
  ...
  @doc """
  Given an offer or an answer in the form of SDP generated by a remote party, set
  Sets the remote description on a peer connection. Expects an SDP offer or answer in
  the form of a UTF-8 encoded string.
